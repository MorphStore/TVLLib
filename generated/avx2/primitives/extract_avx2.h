...
namespace vectorlib{
	template<
	>
	struct extract_value_t <avx2<v128<uint64_t>>,  64> {
...
;
	template<
	>
	struct extract_value_t <avx2<v128<uint32_t>>,  32> {
		MSV_CXX_ATTRIBUTE_FORCE_INLINE
		static
...
;
	template<
	>
	struct extract_value_t <avx2<v128<uint16_t>>,  16> {
		MSV_CXX_ATTRIBUTE_FORCE_INLINE
		static
...
;
	template<
	>
	struct extract_value_t <avx2<v128<uint8_t>>,  8> {
		MSV_CXX_ATTRIBUTE_FORCE_INLINE
		static
...
;
	template<
	>
	struct extract_value_t <avx2<v256<uint64_t>>,  64> {
		MSV_CXX_ATTRIBUTE_FORCE_INLINE
		static
...
;
	template<
	>
	struct extract_value_t <avx2<v256<uint32_t>>,  32> {
		MSV_CXX_ATTRIBUTE_FORCE_INLINE
		static
...
;
	template<
	>
	struct extract_value_t <avx2<v256<uint16_t>>,  16> {
		MSV_CXX_ATTRIBUTE_FORCE_INLINE
		static
...
;
	template<
	>
	struct extract_value_t <avx2<v256<uint8_t>>,  8> {
		MSV_CXX_ATTRIBUTE_FORCE_INLINE
		static
